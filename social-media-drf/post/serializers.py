...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'tags', 'subcategories', 'status', 'rejection_reason', 'created_at', 'updated_at',
    ...
    def get_original_post(self, obj):
        ...
        if obj.shared_from:
            ...
            return {
                ...
                'user_name': original.user.profile.display_name,
                'avatar': avatar,
...
class FollowSerializer(serializers.ModelSerializer):
    ...
    follower_name = serializers.CharField(source='follower.profile.display_name', read_only=True)
    following_name = serializers.CharField(source='following.profile.display_name', read_only=True)
...
class PostReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PostReport
        fields = [
            'id', 'reporter', 'post', 'post_id', 'post_title', 'post_author_details',
