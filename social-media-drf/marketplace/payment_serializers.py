...
class UserSubscriptionSerializer(serializers.ModelSerializer):
    ...
    def get_user(self, obj):
        ...
        return self.get_user_data(obj.user)
    def get_user_data(self, user):
        """Helper to return consistent user data across serializers"""
        avatar_url = None
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    def get_user(self, obj):
        # Reuse user data logic from UserSubscriptionSerializer
        sub_serializer = UserSubscriptionSerializer(context=self.context)
        return sub_serializer.get_user_data(obj.user)
