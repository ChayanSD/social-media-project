...
router.register(
    r"marketplace/subcategories",
    MarketplaceSubCategoryViewSet,
    basename="marketplace-subcategory",
)
router.register(
    r"marketplace/items", MarketplaceProductViewSet, basename="marketplace-item"
)
...
try:
    ...
    router.register(
        r"marketplace/subscription-plans",
        SubscriptionPlanViewSet,
        basename="subscription-plan",
    )
    router.register(
        r"marketplace/subscription",
        UserSubscriptionViewSet,
...
""" Moderation Section """
try:
    from moderation.views import UserModerationStatusViewSet
...
urlpatterns = [
    ...
    path(
        "communities/invite/",
        InviteUserToCommunityView.as_view(),
        name="invite-user-to-community",
    ),
    # Chat user endpoints
    ...
    path(
        ...
        UpdateDirectMessageView.as_view(),
        name="update-direct-message",
    ),
    path(
        "chat/messages/delete/",
        DeleteDirectMessageView.as_view(),
    ...
    path(
        ...
        GetConversationsListView.as_view(),
        name="get-conversations-list",
    ),
    # Message request endpoints
    path(
        "chat/message-requests/",
        GetMessageRequestsView.as_view(),
        name="get-message-requests",
    ),
    path(
        "chat/message-requests/accept/",
        AcceptMessageRequestView.as_view(),
        name="accept-message-request",
    ),
    path(
        "chat/message-requests/reject/",
        RejectMessageRequestView.as_view(),
        name="reject-message-request",
    ),
    path(
        "chat/message-requests/cancel/",
        CancelMessageRequestView.as_view(),
        name="cancel-message-request",
    ),
    # Block and Report endpoints
    path("chat/block/", BlockUserView.as_view(), name="block-user"),
    path(
        "chat/admin/block-local/",
        AdminLocalBlockView.as_view(),
        name="admin-block-local",
    ),
    path(
        "chat/admin/unblock-local/",
        AdminLocalUnblockView.as_view(),
        name="admin-unblock-local",
    ),
    path("chat/unblock/", UnblockUserView.as_view(), name="unblock-user"),
    path(
        "chat/blocked-users/", BlockedUsersListView.as_view(), name="blocked-users-list"
    ),
    ...
    path(
        "chat/reports/<int:report_id>/update/",
        UpdateReportStatusView.as_view(),
        name="update-report-status",
    ),
    path(
        "chat/reports/<int:report_id>/",
        DeleteUserReportView.as_view(),
        name="delete-user-report",
    ),
    # Admin conversations endpoints
    path(
        "chat/admin/conversations/",
        AdminAllConversationsView.as_view(),
        name="admin-all-conversations",
    ),
    path(
        "chat/admin/conversation/messages/",
        AdminGetConversationMessagesView.as_view(),
        name="admin-conversation-messages",
    ),
    path(
        "chat/admin/conversation/delete/",
        AdminDeleteConversationView.as_view(),
        name="admin-delete-conversation",
    ),
    path(
        "chat/admin/conversation/cleanup/",
        AdminCleanupConversationView.as_view(),
        name="admin-cleanup-conversation",
    ),
    path(
        "chat/admin/history/", AdminChatHistoryView.as_view(), name="admin-chat-history"
    ),
