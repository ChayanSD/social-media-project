...
urlpatterns = [
    ...
    path('chat/admin/block-local/', AdminLocalBlockView.as_view(), name='admin-block-local'),
    path('chat/admin/unblock-local/', AdminLocalUnblockView.as_view(), name='admin-unblock-local'),
