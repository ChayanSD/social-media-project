...
export const metadata: Metadata = {
  title: 'Support - Contact Us for Help | Interdimensional Cafe',
  description: 'Get in touch with our support team for assistance with your account, technical issues, billing questions or other concerns. We\'re here to help 24/7.',
  ...
  alternates: {
    canonical: `${siteUrl}/help-support`,
  },
};
...
const contactPageStructuredData = {
  ...
  description: 'Get in touch with our support team for assistance with your account, technical issues, billing questions or other concerns.',
  mainEntity: {
    '@type': 'Organization',
