...
export const metadata: Metadata = {
  title: 'About Us - Our Mission & Values | Interdimensional Cafe',
  description: 'Learn about Interdimensional Cafe, our mission to create vibrant communities, our values and our story. Discover how we\'re building a platform for authentic connections.',
  keywords: ['about us', 'mission', 'values', 'company', 'team', 'story', 'community', 'social platform'],
  openGraph: {
    title: 'About Us - Our Mission & Values | Interdimensional Cafe',
    description: 'Learn about Interdimensional Cafe, our mission to create vibrant communities and our values.',
    type: 'website',
...
const aboutStructuredData = {
  ...
  '@type': 'AboutPage',
  name: 'About Us',
  description: 'Learn about Interdimensional Cafe, our mission to create vibrant communities, our values and our story.',
  mainEntity: {
    '@type': 'Organization',
