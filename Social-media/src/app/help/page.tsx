...
export const metadata: Metadata = {
  title: 'Help Center - Get Support & Answers | Interdimensional Cafe',
  description: 'Find answers to common questions, learn how to use our platform and get help with accounts, communities, posts and more. Comprehensive help center with FAQs and guides.',
