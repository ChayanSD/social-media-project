      ...
      <div className="space-y-6">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <div className={`grid ${getGridCols(mediaFiles.length)} gap-4`}>
              {mediaFiles.map((media, index) => (
                <div
                  key={index}
                  className={`relative rounded-lg overflow-hidden border border-white/10 ${mediaFiles.length === 1 ? "w-full h-96" : "w-full aspect-square"
                    }`}
                >
                  <Image
                    src={
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Post Title</h3>
              <p className="text-lg font-semibold text-white">{postTitle}</p>
            </div>

            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Author</h3>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Post Type</h3>
          ...
          <div className="space-y-4">
            {communityName && (
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="text-base font-medium text-white/60 mb-1">Community</h3>
                <p className="text-lg font-medium text-white">{communityName}</p>
              </div>
            )}

            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Likes</h3>
              <p className="text-xl font-bold text-white">{likesCount}</p>
            </div>

            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Comments</h3>
              <p className="text-xl font-bold text-white">{commentsCount}</p>
            </div>

            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Shares</h3>
        ...
        {content && (
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <h3 className="text-base font-medium text-white/60 mb-2">Content</h3>
            <div
        ...
        {tags.length > 0 && (
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <h3 className="text-base font-medium text-white/60 mb-2">Tags</h3>
            <div className="flex flex-wrap gap-2">
              {tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 rounded-full text-base bg-blue-500/20 text-blue-300"
                >
                  {tag}
                </span>
              ))}
        ...
        {link && (
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <h3 className="text-base font-medium text-white/60 mb-2">Link</h3>
            <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-white/10">
          <div>
            <h3 className="text-base font-medium text-white/60 mb-1">Post ID</h3>
            <p className="text-white/80">#{post.id}</p>
          </div>
          <div>
            <h3 className="text-base font-medium text-white/60 mb-1">Created At</h3>
            <p className="text-white/80">{formatDate(createdAt)}</p>
          </div>
          {updatedAt && (
            <div>
              <h3 className="text-base font-medium text-white/60 mb-1">Last Updated</h3>
              <p className="text-white/80">{formatDate(updatedAt)}</p>
            </div>
          )}
          <div>
            <h3 className="text-base font-medium text-white/60 mb-1">Permissions</h3>
            <div className="flex gap-2">
              ...
              {canDelete && (
                <span className="px-2 py-1 rounded text-sm bg-red-500/20 text-red-300">
                  Can Delete
                </span>
              )}
              {isLiked && (
                <span className="px-2 py-1 rounded text-sm bg-pink-500/20 text-pink-300">
                  Liked
                </span>
              )}
            </div>
