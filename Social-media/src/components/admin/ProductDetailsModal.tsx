  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Service Name</h3>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <span
                className={`inline-block px-3 py-1 rounded-full text-base font-medium ${status === "published"
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Location</h3>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Category</h3>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Subcategory</h3>
              <p className="text-lg font-medium text-white">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-base font-medium text-white/60 mb-1">Seller</h3>
        ...
        {product.description && (
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <h3 className="text-base font-medium text-white/60 mb-2">Description</h3>
        ...
        {product.link && (
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <h3 className="text-base font-medium text-white/60 mb-2">Platform Link</h3>
            <a
              href={product.link}
              target="_blank"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-white/10">
          <div>
            <h3 className="text-base font-medium text-white/60 mb-1">Service ID</h3>
