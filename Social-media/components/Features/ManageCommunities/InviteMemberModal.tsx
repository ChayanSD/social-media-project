                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-white/60 text-base truncate">@{username}</p>
                    </div>
                    ...
                    <button
                      ...
                      disabled={isInviting}
                      className={`px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 border border-blue-500/30 rounded-lg transition-colors font-medium text-base flex items-center gap-2 ${isInviting ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                    >
