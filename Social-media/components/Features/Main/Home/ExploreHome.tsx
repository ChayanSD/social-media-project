...
/**
 * Explore Home Component - For unauthenticated users
 * Shows news feed without requiring authentication
 * Design matches the main Home component
 */
const ExploreHome = () => {
  ...
  const renderPosts = () => {
    ...
    return (
      <>
        <div className="space-y-6 min-h-[60.7vh]  overflow-y-auto custom-scroll">
          {posts.map((post) => (
